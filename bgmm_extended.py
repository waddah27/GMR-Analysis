...
class BGMM(BayesianGaussianMixture):
    def __init__(self, *, n_components = 1, covariance_type = "full", tol = 0.001, reg_covar = 0.000001,
                 ...
                 random_state = None, warm_start: bool = False, verbose = 0, verbose_interval = 10) -> None:
        super().__init__(n_components=n_components, covariance_type=covariance_type, tol=tol, reg_covar=reg_covar,
                         ...
                         mean_prior=mean_prior, degrees_of_freedom_prior=degrees_of_freedom_prior,
                         covariance_prior=covariance_prior, random_state=random_state, warm_start=warm_start,
